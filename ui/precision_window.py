...
class PrecisionWindow(QWidget):
    ...
    def update_calculations(self):
        ...
        if len(rep_vals) > 0:
            ...
            if len(rep_vals) == 6:
                if rep_rsd <= 2.0:
                    self.lblRepStatus.setText("PASS")
                    self.lblRepStatus.setStyleSheet("color: green; font-weight: bold;")
                else:
                    self.lblRepStatus.setText("FAIL")
                    self.lblRepStatus.setStyleSheet("color: red; font-weight: bold;")
            else:
                self.lblRepStatus.setText("Incomplete (Need 6)")
                self.lblRepStatus.setStyleSheet("color: orange; font-weight: bold;")
        else:
            self.lblRepMean.setText("0.00%")
            self.lblRepSD.setText("0.0000")
            self.lblRepRSD.setText("0.00%")
            self.lblRepStatus.setText("Pending")
            self.lblRepStatus.setStyleSheet("color: gray; font-weight: bold;")
        ...
        if len(ip_vals) > 0:
            ...
            if len(ip_vals) == 6:
                if ip_rsd <= 2.0:
                    self.lblIpStatus.setText("PASS")
                    self.lblIpStatus.setStyleSheet("color: green; font-weight: bold;")
                else:
                    self.lblIpStatus.setText("FAIL")
                    self.lblIpStatus.setStyleSheet("color: red; font-weight: bold;")
            else:
                self.lblIpStatus.setText("Incomplete (Need 6)")
                self.lblIpStatus.setStyleSheet("color: orange; font-weight: bold;")
        else:
            self.lblIpMean.setText("0.00%")
            self.lblIpSD.setText("0.0000")
            self.lblIpRSD.setText("0.00%")
            self.lblIpStatus.setText("Pending")
            self.lblIpStatus.setStyleSheet("color: gray; font-weight: bold;")
        ...
        if len(combined_vals) > 0:
            ...
            # If they ran both, check combined criteria. If they only ran Repeatability, base on that.
            if len(rep_vals) == 6 and (len(ip_vals) == 0 or len(ip_vals) == 6):
                if rep_rsd <= 2.0 and (len(ip_vals) == 0 or comb_rsd <= 2.0):
                    self.lblOverallStatus.setText("PASS")
                    self.lblOverallStatus.setStyleSheet("color: green; font-weight: bold; font-size: 14px;")
                else:
                    self.lblOverallStatus.setText("FAIL")
                    self.lblOverallStatus.setStyleSheet("color: red; font-weight: bold; font-size: 14px;")
            else:
                self.lblOverallStatus.setText("Pending Data")
                self.lblOverallStatus.setStyleSheet("color: gray; font-weight: bold; font-size: 14px;")
        else:
